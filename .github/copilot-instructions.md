...
### 既知の脆弱性と対応状況
- **GO-2025-3553** (`github.com/golang-jwt/jwt@v3.2.2`)
  - 間接依存（`labstack/echo/v4/middleware`経由）
  - 影響: JWTミドルウェアを使用していないため実質的な影響なし
  - 対応: Echoの次期バージョンアップデート待ち
  - 回避策: JWT認証機能を使わない限り安全
